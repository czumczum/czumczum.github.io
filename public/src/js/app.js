...
$(function () {
 ...
 // Ajay request
    ...
    $('main').waypoint(function(direction) {
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("#solution-tab").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
    ...
    $('#solution-tab').waypoint(function(direction) {
        if (direction === 'down') {
            $("#main").removeClass("waypoint-here");
            $(this).addClass("waypoint-here");
        }
    }, {
        offset: '50%'
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("#panel-tab1").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
    ...
    $('#panel-tab1').waypoint(function(direction) {
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("#panel-tab2").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
    ...
    $('#panel-tab2').waypoint(function(direction) {
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("#panel-tab3").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
    $('#panel-tab3').waypoint(function(direction) {
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("#panel-tab4").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
    ...
    $('#panel-tab4').waypoint(function(direction) {
        ...
        if (direction === 'up') {
            $(this).addClass("waypoint-here");
            $("form").removeClass("waypoint-here");
        }
    }, {
        offset: '25%'
    });
